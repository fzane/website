...
But the era of AI doesn't need people who can do the work. It needs people who can _get work done_—a phrase that sounds similar but describes an entirely different capability. Think of it as a shift from syntax to semantics: the grammar of business tasks becomes something AI handles. What remains stubbornly human is meaning: what are we actually trying to accomplish, and is this output accomplishing it?
