---
title: "A Busy Week in AI"
date: "2025-05-23"
description: "OpenAI, Anthropic, and Google each made big news the same week — and each revealed a different bet: consumer, enterprise, and platform."
---
...
- **OpenAI**: Acquire Windsurf's coding application and Jony Ive's design company to dominate the chat and feed interfaces, becoming the surface through which users encounter AI in daily life. &rarr; **Consumer**
- **Anthropic**: Use Code with Claude event to release deeply integrated, semi-autonomous agents designed to operate without constant user interaction &rarr; **Enterprise**
- **Google**: Use Google I/O to show off a collection of individual, powerful models across a wide range of capabilities, albeit with a somewhat less compelling product vision. &rarr; **Infrastructure?**
...
- **OpenAI** is fighting for the **top of the UI stack**—not just through chat, but by capturing the _moment of user intention_. What used to be product UI becomes behavioral context. It isn’t replacing Google Search or the Facebook feed—it is becoming the new default page for the Internet.
- **Anthropic** is building a **new middle layer**—AI that performs autonomous labor inside existing tools. Claude doesn’t need to be your friend—it wants to be the thing _inside_ your company that quietly gets work done. Agents instead of users, tasks instead of clicks.
